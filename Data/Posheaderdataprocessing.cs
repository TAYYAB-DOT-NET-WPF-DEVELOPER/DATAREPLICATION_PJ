...
namespace DataIntegration.Data
{
    public class Posheaderdataprocessing
    {
        public Posheader posheaderdataprocessing(DataRow dr, int snum)
        {
            ...
            posheader.Numcust = dr["NUMCUST"] != DBNull.Value ? (int?)dr["NUMCUST"] : null;
            posheader.Tax1 = dr["TAX1"] != DBNull.Value ? (int?)(Convert.ToDouble(dr["TAX1"])) : null;
            posheader.Tax2 = dr["TAX2"] != DBNull.Value ? (int?)(Convert.ToDouble(dr["TAX2"])) : null;
            posheader.Tax1able = dr["TAX1ABLE"] != DBNull.Value ? (int?)(Convert.ToDouble(dr["TAX1ABLE"])) : null;
            posheader.Tax2able = dr["TAX2ABLE"] != DBNull.Value ? (int?)(Convert.ToDouble(dr["TAX2ABLE"])) : null;
            posheader.Nettotal = dr["NETTOTAL"] != DBNull.Value ? (int?)(Convert.ToDouble(dr["NETTOTAL"])) : null;
            ...
            posheader.Issplit = dr["ISSPLIT"] != DBNull.Value ? (int?)dr["ISSPLIT"] : null;
            posheader.Saletypeindex = dr["SALETYPEINDEX"] != DBNull.Value ? (int?)dr["SALETYPEINDEX"] : null;
            posheader.Status = dr["STATUS"] != DBNull.Value ? (int?)dr["STATUS"] : null;
            posheader.Finaltotal = dr["FINALTOTAL"] != DBNull.Value ? (int?)(Convert.ToDouble(dr["FINALTOTAL"])) : null;
            ...
            posheader.Isdelivery = dr["ISDELIVERY"] != DBNull.Value ? (int?)dr["ISDELIVERY"] : null;
            posheader.Tax1exempt = dr["TAX1EXEMPT"] != DBNull.Value ? (int?)dr["TAX1EXEMPT"] : null;
            posheader.Mealtime = dr["MEALTIME"] != DBNull.Value ? (int?)dr["MEALTIME"] : null;
            ...
            posheader.Numprintedfinal = dr["NUMPRINTEDFINAL"] != DBNull.Value ? (int?)dr["NUMPRINTEDFINAL"] : null;
