...
namespace DataIntegration.Data
{
    public class Stocktakedetailprocessing
    {
        public Stocktakedetail processstocktakedeatil(DataRow dr, int snum)
        {
            ...
            stocktakedetail.Startinv = (int?)dr["Startinv"];
            stocktakedetail.Endinv = (int?)dr["Endinv"];
            stocktakedetail.Posused = (int?)dr["Posused"];
            stocktakedetail.Spill = (int?)dr["Spill"];
            stocktakedetail.Transferin = (int?)dr["Transferin"];
            stocktakedetail.Transferout = (int?)dr["Transferout"];
            stocktakedetail.Other = (int?)dr["Other"];
            ...
            stocktakedetail.Snum = (int)dr["Snum"];
