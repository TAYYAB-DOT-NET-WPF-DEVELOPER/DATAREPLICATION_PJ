...
namespace DataIntegration.Data
{
    public class Punchpayrollprocessing
    {
        public Punchpayroll processpunchpayroll(DataRow dr)
        {
            ...
            punchpayroll.Totalhours = dr["Totalhours"] != DBNull.Value ? Convert.ToInt32(dr["Totalhours"]) : null;
            punchpayroll.Breakunpaidhours = dr["Breakunpaidhours"] != DBNull.Value ? Convert.ToInt32(dr["Breakunpaidhours"]) : null;
            punchpayroll.Breakpaidhours = dr["Breakpaidhours"] != DBNull.Value ? Convert.ToInt32(dr["Breakpaidhours"]) : null;
            punchpayroll.Breakhours = dr["Breakhours"] != DBNull.Value ? Convert.ToInt32(dr["Breakhours"]) : null;
            punchpayroll.Paidhours = dr["Paidhours"] != DBNull.Value ? Convert.ToSingle(dr["Paidhours"]) : null;
            punchpayroll.Reghours = dr["Reghours"] != DBNull.Value ? Convert.ToSingle(dr["Reghours"]) : null;
            punchpayroll.Regrate = dr["Regrate"] != DBNull.Value ? Convert.ToSingle(dr["Regrate"]) : null;
            punchpayroll.Totalwage = dr["Totalwage"] != DBNull.Value ? Convert.ToSingle(dr["Totalwage"]) : null;
            punchpayroll.Averagedpayrate = dr["Averagedpayrate"] != DBNull.Value ? Convert.ToSingle(dr["Averagedpayrate"]) : null;
